# Library to convert any image to be Commodore c64 compatible - Creates a prg file - start with SYS 4096
#
    ...
    def conv(self, pic, bc, xsize=160, ysize=200):
     ...
     #1084s bright
        p=[19, 9, 19,
           ...
           26, 61, 228 , 
           240 , 223, 10 , 
           216, 60 , 24 , 140,  35, 21 , 224, 104, 66 , 54 , 40  , 40  , 136 , 122   ,115    , 215, 255, 180, 104, 136, 242, 174, 174, 174]
